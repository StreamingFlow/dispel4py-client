...
seismic_wf = WorkflowGraph()

seismic_wf.connect(streamRead, StreamRead.OUTPUT_NAME, decim, 'input')
seismic_wf.connect(decim, 'output', detrend, 'input')
seismic_wf.connect(detrend, 'output', demean, 'input')
seismic_wf.connect(demean, 'output', removeResponse, 'input')
seismic_wf.connect(removeResponse, 'output', filt, 'input')
seismic_wf.connect(filt, 'output', calNorm, 'input')
seismic_wf.connect(calNorm, 'output', whiten, 'input')
seismic_wf.connect(whiten, 'output', calcFft, 'input')
seismic_wf.connect(calcFft, 'output', streamToFile, StreamToFile.INPUT_NAME)
